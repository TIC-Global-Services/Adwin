...
const About = () => {
    ...
    return (
      <div className="relative mx-auto  px-4 lg:px-16 md:pt-20 pt-10 md:pb-0 pb-10 ">
        {/* Content Section */}
        ...
        >
          <div className="w-full lg:w-1/2 relative flex items-end justify-end">
            <Image 
              src={Model} 
              alt="About Adwin" 
              className=" md:max-w-2xl pr-10 h-auto object-contain"
              priority
            />
            <div className='md:hidden absolute bottom-0 bg-gradient-to-t from-white via-white/50 to-white/0 h-[20dvh] w-full'></div>
          </div>

          <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start gap-6 text-center lg:text-left md:mt-0 mt-10 ml-8 ">
